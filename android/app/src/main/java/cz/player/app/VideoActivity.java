...
public class VideoActivity extends Activity {
     ...
     *
     * Volat **až po `setContentView`**. `getInsetsController()` si sahá na
     * dekoraci okna a ta do té doby neexistuje - na Androidu 15 z toho padá
     * `NullPointerException`. Tohle byl ten důvod, proč klepnutí na film
     * nedělalo vůbec nic: přehrávač spadl v `onCreate` dřív, než stihl cokoli
     * nakreslit, a obrazovka zmizela rychleji, než se stačila ukázat.
     *
